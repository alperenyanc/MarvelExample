  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.info_box}>
        <Text style={[styles.title,textStyles.bold]}>COMPANY INFO AND CONTACT</Text>
        ...
        <Text style={[styles.title,textStyles.bold]}>Corporate Headquarters</Text>
        <Text style={[styles.descriptions,textStyles.boldSemi]}>
          Marvel Entertainment, LLC 1290 Avenue of the Americas New York, NY 10104
        </Text>
        <Text style={[styles.title,textStyles.bold]}>More Info</Text>
        <Text 
       onPress={() => Linking.openURL('https://www.marvel.com/corporate/about')}
        style={[styles.title,textStyles.boldNC,{color:'red'}]}>www.marvel.com</Text>
